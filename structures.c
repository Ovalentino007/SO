...
void init_process_queue(ProcessQueue *queue, int max_capacidad){

    queue->procesos = malloc(max_capacidad * sizeof(PCB));
    queue->cont = 0;
...
void init_machine(Machine *machine, int cpus, int cores, int threads){
